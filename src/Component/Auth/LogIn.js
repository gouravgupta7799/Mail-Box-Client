...
setToggle(!toggle)
  ...
  const submitHandler=(e)=>{
    e.preventDefault();
    if(!toggle){
      fetch('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDPb8_eVDcDttXa2z1AZsFefzvseA_1Ba4',{
        method:'POST',
     ...
     dispatch(userAction.localIdUpdater(res.localId))
      ...
      fetch('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDPb8_eVDcDttXa2z1AZsFefzvseA_1Ba4',{
        method:'POST',
