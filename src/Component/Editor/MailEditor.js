...
//   console.log(contentState.blocks[0].text)
 ...
 const sendHandler =async(e)=>{
    e.preventDefault();
   await fetch(`https://mailboxclient-dc189-default-rtdb.firebaseio.com/${userData.localId}/mailSent.json`,{
        method:'POST',
        body:JSON.stringify({
            sentTo:toSender,
            subject:subject,
   ...
   await fetch(`https://mailboxclient-dc189-default-rtdb.firebaseio.com/${userData.localId}/mailRecived.json`,{
        method:'POST',
        body:JSON.stringify({
            sentTo:toSender,
            subject:subject,
